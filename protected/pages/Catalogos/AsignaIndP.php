...
class AsignaIndP extends TPage
{
	var $cn;
	...
	{
		$this->cn->enlaza($this->ddlCG, "SELECT cg.id_cg, CONCAT(cg.clave, ' ', cg.denominacion) as cg FROM cg JOIN cg_programas_indicadores cpi ON cg.id_cg = cpi.id_cg WHERE cpi.id_programa = :id_programa", array("id_programa"=>$this->ddlPrograma->SelectedValue));
		$this->ddlCG_Changed();
	}
